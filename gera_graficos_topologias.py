...
def gera_graficos(topologia,cont_total):
    ...
    for caminho in arquivos:
        ...
        plt.title("Gráfico "+str(cont_total)+" - "+topologia+" - RTT com "+cliente+" cliente(s) e intervalo de "+str(intervalo)+"s")
        plt.savefig(topologia+"/Graficos/Gráfico "+str(cont_total)+" - RTT com "+cliente+" cliente(s) e intervalo de "+str(intervalo)+"s.png")
        cont_total+=1
        cont+=1
        plt.show()
    return cont_total
